...
// LibraryAppDoc.cpp: реализация класса CLibraryAppDoc 
//
...
IMPLEMENT_DYNCREATE(CLibraryAppDoc, CDocument)

BEGIN_MESSAGE_MAP(CLibraryAppDoc, CDocument)
END_MESSAGE_MAP()


// Создание или уничтожение CLibraryAppDoc
