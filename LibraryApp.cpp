...
// LibraryApp.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CLibraryAppApp, CWinApp)
...
// Единственный объект CLibraryAppApp

CLibraryAppApp theApp;


// Инициализация CLibraryAppApp
...
// Обработчики сообщений CLibraryAppApp
